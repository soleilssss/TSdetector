...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    classes_path    = r'/data/wkn/sun_dataset/code/yolox-timeimage-sim-LSTM-wb/model_data/sun_classes.txt'
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = r'/data/wkn/sun_dataset/code/yolox-timeimage-sim-Lstm-tada/model_data/yolox_x.pth'
    #------------------------------------------------------#
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    train_annotation_path   = 'sun_train.txt'
    val_annotation_path     = 'sun_val.txt'
    ...
    #   获取classes和anchor
    #----------------------------------------------------#
    class_names, num_classes = get_classes(classes_path)  #["polyp"], 1
    ...
    if True:
        ...
        train_dataset   = YoloDataset(train_lines, input_shape, num_classes, epoch_length = UnFreeze_Epoch, \
                                            mosaic=mosaic, mixup=mixup, mosaic_prob=mosaic_prob, mixup_prob=mixup_prob, train=True, videorange = videorange, framerange = framerange, special_aug_ratio=special_aug_ratio)
        val_dataset     = YoloDataset(val_lines, input_shape, num_classes, epoch_length = UnFreeze_Epoch, \
                                            mosaic=False, mixup=False, mosaic_prob=0, mixup_prob=0, train=False, videorange = videorange, framerange = framerange, special_aug_ratio=0)
        ...
        #----------------------#
        if local_rank == 0:
            eval_callback   = EvalCallback(model, input_shape, class_names, num_classes, val_lines, log_dir, Cuda, videorange = videorange, framerange = framerange, \
